...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "https://github.com/ilmannafi/fiber-boilerplate",
    ...
    "definitions": {
        ...
        "auth.TokenResponse": {
            ...
            "properties": {
                "access_token": {
                    "type": "string",
                    "example": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwidHlwIjoiYWNjZXNzIn0 signature"
                },
                "expires_in": {
                    "type": "integer",
                    "example": 900
                ...
                "refresh_token": {
                    "type": "string",
                    "example": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwidHlwIjoicmVmcmVzaCJ9 signature"
                },
                "token_type": {
                    "type": "string",
                    "example": "Bearer"
